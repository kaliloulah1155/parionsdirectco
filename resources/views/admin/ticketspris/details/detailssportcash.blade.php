   ...
   <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">Liste sportcash</h4>
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Liste des tickets pris</a></li>
                            <li class="breadcrumb-item active" aria-current="page"> <a href="{{route('sportcash')}}">sportcash</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <table class="table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $results->data->ticket_id }}</td>
                            </tr>
                            <tr>
                                <td><h4>Montant</h4></td>
                                <td>{{ $results->data->win_amount }}</td>
                            </tr>
                            <tr>
