...
@section('content')
    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">Liste des PMU ALR</h4>
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Liste des tickets pris</a></li>
                            <li class="breadcrumb-item active" aria-current="page">PMU ALR</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form class="form-horizontal" action="{{route('pmualr')}}" method="POST">
                         @csrf
                        <div class="card-body">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Statistiques relatives aux pmu alr </h5>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Statistiques relatives aux alr </h5>
                        <div class="table-responsive">
                            <table id="zero_config1" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                     ...
                                     @if(!empty($response_alr_data))
                                            @foreach ($response_alr_data as $list)
                                             @if(!empty($list->bet_status))  
                                                <tr>
                                                    <td>{{ $list->bet_status }}</td>
                                                    <td>{{ $list->sale_client_id }}</td>
                                                    <td>{{ $list->race_id }}</td>
                                                    ...
                                                    <td style="text-align: center">
                                                        @if($list->bet_status=="Vainqueur en attente de paiement")
                                                         <!--    <label class="checkbox-inline"> Valider paiement</label> -->
                                                             ...
                                                             <hr/>
                                                        @endif
                                                        <a  href="{{ URL::to('/admin/detailspmualr/'.$list->transaction_id) }}"  class="btn btn-cyan btn-sm  mdi mdi-account-star-variant" title="Détails"></a>
                                                    </td>
                                                 </tr>
                                            @endif
                                        @endforeach
