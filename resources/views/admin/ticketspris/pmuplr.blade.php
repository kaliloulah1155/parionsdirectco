...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form class="form-horizontal" action="{{route('pmuplr')}}" method="POST">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Statistiques relatives aux pmu plr </h5>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="zero_config1" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    @if(!empty($response_plr_data))
                                            @foreach ($response_plr_data as $list)
                                                    ...
                                                    <td style="text-align: center">
                                                        @if($list->bet_status=="Vainqueur en attente de paiement")
                                                         <!--    <label class="checkbox-inline"> Valider paiement</label> -->
                                                             ...
                                                             <hr/>
                                                        @endif
                                                        <a  href="{{ URL::to('/admin/detailspmuplr/'.$list->transaction_id) }}"  class="btn btn-cyan btn-sm  mdi mdi-account-star-variant" title="Détails"></a>
                                                    </td>
                                                </tr>
                                            @endif
                                        @endforeach
                                   ...
                                   <!-- <td> <span class="far fa-thumbs-down"></span> &nbsp;En cours</td>-->
                                </tbody>
                            </table>
                        </div>
                    </div>
