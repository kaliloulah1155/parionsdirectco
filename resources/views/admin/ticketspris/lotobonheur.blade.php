...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form class="form-horizontal" action="{{route('lotobonheur')}}" method="POST">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Statistiques relatives aux loto bonheur </h5>
                                ...
                                <tbody>
                                 <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td></td>
                                       <td style="text-align: center">{{ $mntrembourser }}</td>
                                    </tr>
                                    <tr>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Tickets rélatifs aux jeux loto bonheur </h5>
                        <div class="table-responsive">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center">
                                                        @if($list->bet_status=="Vainqueur en attente de paiement")
                                                             ...
                                                             <div class="checkbox">
                                                                    <input type="checkbox" name="valid"  id="valid{{$list->transaction_id}}"  class="cvalid{{$list->transaction_id}}" data-toggle="toggle" data-size="mini" data-on="Valide" data-off="Invalide" />
                                                             </div>
                                                              <input type="hidden"  id="hidden_valid{{$list->transaction_id}}" value="{{$list->transaction_id}}" />
                                                             <hr/>
                                                             
                                                        @endif
                                                        <a  href="{{ URL::to('/admin/detailsloto/'.$list->transaction_id) }}"  class="btn btn-cyan btn-sm  mdi mdi-account-star-variant" title="Détails"></a>
                                                    </td>
                                                </tr>
                                            @endif
                                        @endforeach
