...
@section('content')
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">Création de profils d'administration</h4>
    ...
    <div class="container-fluid" data-find="_7">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form class="form-horizontal" method="POST" action="{{ route('store_role')}}" name="add_profil" id="add_profil" novalidate="novalidate">
                        @csrf
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="intitle" name="name"  placeholder="Veuillez entrer l'intitulé du profil">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="depart" class="col-sm-3 text-right control-label col-form-label">Département</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="departement" name="departement" placeholder="Veuillez rentrer le nom du chef de département">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="lname" class="col-sm-3 text-right control-label col-form-label">Responsable</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="responsable" name="responsable" placeholder="Veuillez entrer le nom du chef de département">
                                </div>
                            </div>
                        </div>
                        @can('Création de profil')
