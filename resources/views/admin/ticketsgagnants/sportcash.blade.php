            ...
            <div class="col-12">
                <div class="card">
                    <div class="border-top">
                        <div class="card-body">
                            <a  href="{{route('exportsportcash')}}"  class="btn btn-danger">EXPORTER</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="table-responsive">
                            <table id="zero_config" class="table table-striped table-bordered">
                                ...
                                @foreach ($lists as $list)
                                    <tr>
                                        <td>{{  (new DateTime($list->created_at))->format('d/m/Y ') }}</td>
                                        <td>sportcash</td>
                                        <td>{{  $list->bet_status }}</td>
                                        <td>{{  $list->transaction_id }}</td>
                                        <td>{{  $list->amount }}</td>
                                        <td>{{  $list->win_amount  }}</td>
                                        <td>Date de debut:{{   (new DateTime($list->begin_at))->format('d/m/Y ') }} Date de fin: {{  (new DateTime($list->end_at))->format('d/m/Y ') }}</td>
